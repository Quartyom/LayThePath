...
public class PremiumIsActivated implements Screen {
    ...
    public PremiumIsActivated(final MakeTheWay game){
        this.game = game;
        ...
        deactivate_button = new Button("in_main_menu", game, new EventHandler() {
            @Override
            public void execute() {
